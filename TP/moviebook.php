...
<div class="container mb-3">
    ...
    <form class="row g-3 needs-validation" method="post" action="testprocess.php?mode=<?= $mode ?>" novalidate>
        <div class="form-floating mb-3">
            <input type="text" class="form-control" maxlength="13" id="bookName" name="bookName" placeholder="제목" value="<?= $bookName ?>" required>
        ...
        <div class="form-floating mb-3">
            <input type="number" class="form-control" id="price" name="price" placeholder="가격" value="<?= $price ?>" required>
